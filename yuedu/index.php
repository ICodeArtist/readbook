...
if($_GET['token'] != 'DAISHUAI'){exit(jsonCode('error', 'token error'));}
...
define('HS_DB_NAME'    , 'orianna');     // 数据库名称
define('HS_DB_USER'    , 'orianna');      // 数据库账号
define('HS_DB_PWD'     , 'Tjb5DwxwbkNddm8a');      // 数据库密码
define('HS_DB_PRE'     , 'yuedu_');    // 数据表统一前缀
define('HS_DB_CHARSET' , 'utf8');   // mysql 字符集类型

/* 微信小程序相关设置  */
define('HS_APPID'  , 'wx5d00be8227767e24');
define('HS_SECRET' , 'ba1de1c6fa0c018728629a84c7b3c673');
